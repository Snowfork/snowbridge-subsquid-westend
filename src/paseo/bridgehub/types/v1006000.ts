...
export const ChannelId = sts.bytes()

export const Id = sts.number()

export type AggregateMessageOrigin = AggregateMessageOrigin_Here | AggregateMessageOrigin_Parent | AggregateMessageOrigin_Sibling | AggregateMessageOrigin_Snowbridge | AggregateMessageOrigin_SnowbridgeV2
...
export interface AggregateMessageOrigin_Snowbridge {
    __kind: 'Snowbridge'
    value: ChannelId
}

export interface AggregateMessageOrigin_SnowbridgeV2 {
    __kind: 'SnowbridgeV2'
    value: H256
}
