...
export const reserveTransferAssets =  {
    ...
    v1001002: new CallType(
        ...
        sts.struct({
            dest: v1001002.VersionedMultiLocation,
            beneficiary: v1001002.VersionedMultiLocation,
            assets: v1001002.VersionedMultiAssets,
    ...
    v1005001: new CallType(
        'PolkadotXcm.reserve_transfer_assets',
        sts.struct({
            dest: v1005001.VersionedLocation,
            beneficiary: v1005001.VersionedLocation,
            assets: v1005001.VersionedAssets,
            feeAssetItem: sts.number(),
        })
    ),
}
...
export const limitedReserveTransferAssets =  {
    ...
    v1001002: new CallType(
        ...
        sts.struct({
            ...
            assets: v1001002.VersionedMultiAssets,
            feeAssetItem: sts.number(),
            weightLimit: v1001002.V3WeightLimit,
        })
    ),
    /**
     * See [`Pallet::limited_reserve_transfer_assets`].
    ...
    v1005001: new CallType(
        ...
        sts.struct({
            ...
            assets: v1005001.VersionedAssets,
            feeAssetItem: sts.number(),
            weightLimit: v1005001.V3WeightLimit,
        })
    ),
}
...
export const transferAssetsUsingTypeAndThen =  {
    ...
    v1002005: new CallType(
        ...
        sts.struct({
            dest: v1002005.VersionedLocation,
            assets: v1002005.VersionedAssets,
            assetsTransferType: v1002005.TransferType,
            remoteFeesId: v1002005.VersionedAssetId,
            feesTransferType: v1002005.TransferType,
            customXcmOnDest: v1002005.VersionedXcm,
            weightLimit: v1002005.V3WeightLimit,
        })
    ),
    /**
    ...
    v1005001: new CallType(
        ...
        sts.struct({
            dest: v1005001.VersionedLocation,
            assets: v1005001.VersionedAssets,
            assetsTransferType: v1005001.TransferType,
            remoteFeesId: v1005001.VersionedAssetId,
            feesTransferType: v1005001.TransferType,
            customXcmOnDest: v1005001.VersionedXcm,
            weightLimit: v1005001.V3WeightLimit,
        })
    ),
}
