...
export const functions = {
    ...
    allowance: viewFun("0xdd62ed3e", "allowance(address,address)", {"_owner": p.address, "spender": p.address}, p.uint256),
...
export class Contract extends ContractBase {
    ...
    allowance(_owner: AllowanceParams["_owner"], spender: AllowanceParams["spender"]) {
        return this.eth_call(functions.allowance, {_owner, spender})
    }
