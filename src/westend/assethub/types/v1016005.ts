...
export const Type_346: sts.Type<Type_346> = sts.closedEnum(() => {
    return  {
        V3: sts.array(() => Type_349),
        V4: sts.array(() => Type_353),
        V5: sts.array(() => Type_356),
    }
})
...
export type Type_356 = Type_356_AliasOrigin | Type_356_BurnAsset | Type_356_BuyExecution | Type_356_ClaimAsset | Type_356_ClearError | Type_356_ClearOrigin | Type_356_ClearTopic | Type_356_ClearTransactStatus | Type_356_DepositAsset | Type_356_DepositReserveAsset | Type_356_DescendOrigin | Type_356_ExchangeAsset | Type_356_ExpectAsset | Type_356_ExpectError | Type_356_ExpectOrigin | Type_356_ExpectPallet | Type_356_ExpectTransactStatus | Type_356_ExportMessage | Type_356_HrmpChannelAccepted | Type_356_HrmpChannelClosing | Type_356_HrmpNewChannelOpenRequest | Type_356_InitiateReserveWithdraw | Type_356_InitiateTeleport | Type_356_InitiateTransfer | Type_356_LockAsset | Type_356_NoteUnlockable | Type_356_PayFees | Type_356_QueryPallet | Type_356_QueryResponse | Type_356_ReceiveTeleportedAsset | Type_356_RefundSurplus | Type_356_ReportError | Type_356_ReportHolding | Type_356_ReportTransactStatus | Type_356_RequestUnlock | Type_356_ReserveAssetDeposited | Type_356_SetAppendix | Type_356_SetAssetClaimer | Type_356_SetErrorHandler | Type_356_SetFeesMode | Type_356_SetTopic | Type_356_SubscribeVersion | Type_356_Transact | Type_356_TransferAsset | Type_356_TransferReserveAsset | Type_356_Trap | Type_356_UniversalOrigin | Type_356_UnlockAsset | Type_356_UnpaidExecution | Type_356_UnsubscribeVersion | Type_356_WithdrawAsset

export interface Type_356_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V5Location
}

export interface Type_356_BurnAsset {
    __kind: 'BurnAsset'
    value: V5Asset[]
}
...
export interface Type_356_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_356_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_356_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V5Asset[]
}

export interface Type_356_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V5Error] | undefined)
}

export interface Type_356_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V5Location | undefined)
}

export interface Type_356_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_356_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_356_ExportMessage {
    __kind: 'ExportMessage'
    network: V5NetworkId
    destination: V5Junctions
    xcm: V5Instruction[]
...
export interface Type_356_InitiateTransfer {
    __kind: 'InitiateTransfer'
    destination: V5Location
    remoteFees?: (V5AssetTransferFilter | undefined)
    preserveOrigin: boolean
...
export interface Type_356_LockAsset {
    __kind: 'LockAsset'
    asset: V5Asset
    unlocker: V5Location
}

export interface Type_356_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V5Asset
    owner: V5Location
}

export interface Type_356_PayFees {
    __kind: 'PayFees'
    asset: V5Asset
}

export interface Type_356_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V5QueryResponseInfo
}
...
export interface Type_356_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V5QueryResponseInfo
    assets: V5AssetFilter
}

export interface Type_356_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V5QueryResponseInfo
}

export interface Type_356_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V5Asset
    locker: V5Location
}
...
export interface Type_356_SetAssetClaimer {
    __kind: 'SetAssetClaimer'
    location: V5Location
}
...
export interface Type_356_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_356_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_356_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V5Junction
}

export interface Type_356_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V5Asset
    target: V5Location
}

export interface Type_356_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V5Location | undefined)
}
...
export type Type_349 = Type_349_AliasOrigin | Type_349_BurnAsset | Type_349_BuyExecution | Type_349_ClaimAsset | Type_349_ClearError | Type_349_ClearOrigin | Type_349_ClearTopic | Type_349_ClearTransactStatus | Type_349_DepositAsset | Type_349_DepositReserveAsset | Type_349_DescendOrigin | Type_349_ExchangeAsset | Type_349_ExpectAsset | Type_349_ExpectError | Type_349_ExpectOrigin | Type_349_ExpectPallet | Type_349_ExpectTransactStatus | Type_349_ExportMessage | Type_349_HrmpChannelAccepted | Type_349_HrmpChannelClosing | Type_349_HrmpNewChannelOpenRequest | Type_349_InitiateReserveWithdraw | Type_349_InitiateTeleport | Type_349_LockAsset | Type_349_NoteUnlockable | Type_349_QueryPallet | Type_349_QueryResponse | Type_349_ReceiveTeleportedAsset | Type_349_RefundSurplus | Type_349_ReportError | Type_349_ReportHolding | Type_349_ReportTransactStatus | Type_349_RequestUnlock | Type_349_ReserveAssetDeposited | Type_349_SetAppendix | Type_349_SetErrorHandler | Type_349_SetFeesMode | Type_349_SetTopic | Type_349_SubscribeVersion | Type_349_Transact | Type_349_TransferAsset | Type_349_TransferReserveAsset | Type_349_Trap | Type_349_UniversalOrigin | Type_349_UnlockAsset | Type_349_UnpaidExecution | Type_349_UnsubscribeVersion | Type_349_WithdrawAsset

export interface Type_349_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_349_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_349_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_349_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_349_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_349_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_349_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_349_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_349_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_349_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_349_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_349_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_349_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_349_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_349_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_349_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_349_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_349_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_349_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_349_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_349_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_346 = Type_346_V3 | Type_346_V4 | Type_346_V5
...
export interface Type_346_V4 {
    __kind: 'V4'
    value: Type_353[]
}

export interface Type_346_V5 {
    __kind: 'V5'
    value: Type_356[]
}
