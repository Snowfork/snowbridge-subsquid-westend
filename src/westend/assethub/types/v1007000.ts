...
export const Type_315: sts.Type<Type_315> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_318),
        V3: sts.array(() => Type_322),
        V4: sts.array(() => Type_325),
    }
})
...
export const Type_325: sts.Type<Type_325> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_325),
        SetErrorHandler: sts.array(() => Type_325),
...
export const Type_319: sts.Type<Type_319> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export type Type_325 = Type_325_AliasOrigin | Type_325_BurnAsset | Type_325_BuyExecution | Type_325_ClaimAsset | Type_325_ClearError | Type_325_ClearOrigin | Type_325_ClearTopic | Type_325_ClearTransactStatus | Type_325_DepositAsset | Type_325_DepositReserveAsset | Type_325_DescendOrigin | Type_325_ExchangeAsset | Type_325_ExpectAsset | Type_325_ExpectError | Type_325_ExpectOrigin | Type_325_ExpectPallet | Type_325_ExpectTransactStatus | Type_325_ExportMessage | Type_325_HrmpChannelAccepted | Type_325_HrmpChannelClosing | Type_325_HrmpNewChannelOpenRequest | Type_325_InitiateReserveWithdraw | Type_325_InitiateTeleport | Type_325_LockAsset | Type_325_NoteUnlockable | Type_325_QueryPallet | Type_325_QueryResponse | Type_325_ReceiveTeleportedAsset | Type_325_RefundSurplus | Type_325_ReportError | Type_325_ReportHolding | Type_325_ReportTransactStatus | Type_325_RequestUnlock | Type_325_ReserveAssetDeposited | Type_325_SetAppendix | Type_325_SetErrorHandler | Type_325_SetFeesMode | Type_325_SetTopic | Type_325_SubscribeVersion | Type_325_Transact | Type_325_TransferAsset | Type_325_TransferReserveAsset | Type_325_Trap | Type_325_UniversalOrigin | Type_325_UnlockAsset | Type_325_UnpaidExecution | Type_325_UnsubscribeVersion | Type_325_WithdrawAsset

export interface Type_325_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_325_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}
...
export interface Type_325_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V4Asset[]
    ticket: V4Location
}

export interface Type_325_ClearError {
    __kind: 'ClearError'
}

export interface Type_325_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_325_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_325_ClearTransactStatus {
...
export interface Type_325_DescendOrigin {
...
export interface Type_325_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_325_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_325_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V4Location | undefined)
}

export interface Type_325_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_325_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_325_ExportMessage {
...
export interface Type_325_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_325_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_325_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}
...
export interface Type_325_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_325_ReportError {
    __kind: 'ReportError'
    value: V4QueryResponseInfo
}

export interface Type_325_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_325_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_325_RequestUnlock {
...
export interface Type_325_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_325[]
}

export interface Type_325_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_325[]
}

export interface Type_325_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_325_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_325_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_325_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_325_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_325_UnpaidExecution {
...
export type Type_322 = Type_322_AliasOrigin | Type_322_BurnAsset | Type_322_BuyExecution | Type_322_ClaimAsset | Type_322_ClearError | Type_322_ClearOrigin | Type_322_ClearTopic | Type_322_ClearTransactStatus | Type_322_DepositAsset | Type_322_DepositReserveAsset | Type_322_DescendOrigin | Type_322_ExchangeAsset | Type_322_ExpectAsset | Type_322_ExpectError | Type_322_ExpectOrigin | Type_322_ExpectPallet | Type_322_ExpectTransactStatus | Type_322_ExportMessage | Type_322_HrmpChannelAccepted | Type_322_HrmpChannelClosing | Type_322_HrmpNewChannelOpenRequest | Type_322_InitiateReserveWithdraw | Type_322_InitiateTeleport | Type_322_LockAsset | Type_322_NoteUnlockable | Type_322_QueryPallet | Type_322_QueryResponse | Type_322_ReceiveTeleportedAsset | Type_322_RefundSurplus | Type_322_ReportError | Type_322_ReportHolding | Type_322_ReportTransactStatus | Type_322_RequestUnlock | Type_322_ReserveAssetDeposited | Type_322_SetAppendix | Type_322_SetErrorHandler | Type_322_SetFeesMode | Type_322_SetTopic | Type_322_SubscribeVersion | Type_322_Transact | Type_322_TransferAsset | Type_322_TransferReserveAsset | Type_322_Trap | Type_322_UniversalOrigin | Type_322_UnlockAsset | Type_322_UnpaidExecution | Type_322_UnsubscribeVersion | Type_322_WithdrawAsset

export interface Type_322_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_322_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_322_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_322_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_322_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_322_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_322_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_322_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_322_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_322_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_322_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_322_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_322_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_322_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_322_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_322_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_322_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_322_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_322_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_322_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_322_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export const Type_318: sts.Type<Type_318> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_318),
        SetErrorHandler: sts.array(() => Type_318),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_318 = Type_318_BuyExecution | Type_318_ClaimAsset | Type_318_ClearError | Type_318_ClearOrigin | Type_318_DepositAsset | Type_318_DepositReserveAsset | Type_318_DescendOrigin | Type_318_ExchangeAsset | Type_318_HrmpChannelAccepted | Type_318_HrmpChannelClosing | Type_318_HrmpNewChannelOpenRequest | Type_318_InitiateReserveWithdraw | Type_318_InitiateTeleport | Type_318_QueryHolding | Type_318_QueryResponse | Type_318_ReceiveTeleportedAsset | Type_318_RefundSurplus | Type_318_ReportError | Type_318_ReserveAssetDeposited | Type_318_SetAppendix | Type_318_SetErrorHandler | Type_318_SubscribeVersion | Type_318_Transact | Type_318_TransferAsset | Type_318_TransferReserveAsset | Type_318_Trap | Type_318_UnsubscribeVersion | Type_318_WithdrawAsset
...
export interface Type_318_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_318_ClearError {
    __kind: 'ClearError'
}

export interface Type_318_ClearOrigin {
    __kind: 'ClearOrigin'
}
...
export interface Type_318_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}
...
export interface Type_318_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_318_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_318_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_318_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_318_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_318[]
}

export interface Type_318_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_318[]
}

export interface Type_318_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}
...
export interface Type_318_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_318_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export type Type_315 = Type_315_V2 | Type_315_V3 | Type_315_V4
...
export interface Type_315_V3 {
    __kind: 'V3'
    value: Type_322[]
}

export interface Type_315_V4 {
    __kind: 'V4'
    value: Type_325[]
}
