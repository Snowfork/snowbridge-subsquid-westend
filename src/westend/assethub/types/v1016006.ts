...
export const Type_347: sts.Type<Type_347> = sts.closedEnum(() => {
    return  {
        V3: sts.array(() => Type_350),
        V4: sts.array(() => Type_354),
        V5: sts.array(() => Type_357),
    }
})
...
export const Type_357: sts.Type<Type_357> = sts.closedEnum(() => {
    return  {
        ...
        SetAppendix: sts.array(() => Type_357),
        SetAssetClaimer: sts.enumStruct({
            location: V5Location,
        }),
        SetErrorHandler: sts.array(() => Type_357),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export type Type_357 = Type_357_AliasOrigin | Type_357_BurnAsset | Type_357_BuyExecution | Type_357_ClaimAsset | Type_357_ClearError | Type_357_ClearOrigin | Type_357_ClearTopic | Type_357_ClearTransactStatus | Type_357_DepositAsset | Type_357_DepositReserveAsset | Type_357_DescendOrigin | Type_357_ExchangeAsset | Type_357_ExecuteWithOrigin | Type_357_ExpectAsset | Type_357_ExpectError | Type_357_ExpectOrigin | Type_357_ExpectPallet | Type_357_ExpectTransactStatus | Type_357_ExportMessage | Type_357_HrmpChannelAccepted | Type_357_HrmpChannelClosing | Type_357_HrmpNewChannelOpenRequest | Type_357_InitiateReserveWithdraw | Type_357_InitiateTeleport | Type_357_InitiateTransfer | Type_357_LockAsset | Type_357_NoteUnlockable | Type_357_PayFees | Type_357_QueryPallet | Type_357_QueryResponse | Type_357_ReceiveTeleportedAsset | Type_357_RefundSurplus | Type_357_ReportError | Type_357_ReportHolding | Type_357_ReportTransactStatus | Type_357_RequestUnlock | Type_357_ReserveAssetDeposited | Type_357_SetAppendix | Type_357_SetAssetClaimer | Type_357_SetErrorHandler | Type_357_SetFeesMode | Type_357_SetTopic | Type_357_SubscribeVersion | Type_357_Transact | Type_357_TransferAsset | Type_357_TransferReserveAsset | Type_357_Trap | Type_357_UniversalOrigin | Type_357_UnlockAsset | Type_357_UnpaidExecution | Type_357_UnsubscribeVersion | Type_357_WithdrawAsset

export interface Type_357_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V5Location
}

export interface Type_357_BurnAsset {
    __kind: 'BurnAsset'
    value: V5Asset[]
}
...
export interface Type_357_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_357_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_357_ExecuteWithOrigin {
    __kind: 'ExecuteWithOrigin'
    descendantOrigin?: (V5Junctions | undefined)
    xcm: Type_357[]
}

export interface Type_357_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V5Asset[]
}

export interface Type_357_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V5Error] | undefined)
}

export interface Type_357_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V5Location | undefined)
}

export interface Type_357_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_357_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_357_ExportMessage {
    __kind: 'ExportMessage'
    network: V5NetworkId
    destination: V5Junctions
    xcm: V5Instruction[]
...
export interface Type_357_InitiateTransfer {
    __kind: 'InitiateTransfer'
    destination: V5Location
    remoteFees?: (V5AssetTransferFilter | undefined)
    preserveOrigin: boolean
...
export interface Type_357_LockAsset {
    __kind: 'LockAsset'
    asset: V5Asset
    unlocker: V5Location
}

export interface Type_357_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V5Asset
    owner: V5Location
}

export interface Type_357_PayFees {
    __kind: 'PayFees'
    asset: V5Asset
}

export interface Type_357_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V5QueryResponseInfo
}
...
export interface Type_357_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V5QueryResponseInfo
    assets: V5AssetFilter
}

export interface Type_357_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V5QueryResponseInfo
}

export interface Type_357_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V5Asset
    locker: V5Location
}
...
export interface Type_357_SetAssetClaimer {
    __kind: 'SetAssetClaimer'
    location: V5Location
}
...
export interface Type_357_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_357_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_357_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V5Junction
}

export interface Type_357_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V5Asset
    target: V5Location
}

export interface Type_357_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V5Location | undefined)
}
...
export type Type_350 = Type_350_AliasOrigin | Type_350_BurnAsset | Type_350_BuyExecution | Type_350_ClaimAsset | Type_350_ClearError | Type_350_ClearOrigin | Type_350_ClearTopic | Type_350_ClearTransactStatus | Type_350_DepositAsset | Type_350_DepositReserveAsset | Type_350_DescendOrigin | Type_350_ExchangeAsset | Type_350_ExpectAsset | Type_350_ExpectError | Type_350_ExpectOrigin | Type_350_ExpectPallet | Type_350_ExpectTransactStatus | Type_350_ExportMessage | Type_350_HrmpChannelAccepted | Type_350_HrmpChannelClosing | Type_350_HrmpNewChannelOpenRequest | Type_350_InitiateReserveWithdraw | Type_350_InitiateTeleport | Type_350_LockAsset | Type_350_NoteUnlockable | Type_350_QueryPallet | Type_350_QueryResponse | Type_350_ReceiveTeleportedAsset | Type_350_RefundSurplus | Type_350_ReportError | Type_350_ReportHolding | Type_350_ReportTransactStatus | Type_350_RequestUnlock | Type_350_ReserveAssetDeposited | Type_350_SetAppendix | Type_350_SetErrorHandler | Type_350_SetFeesMode | Type_350_SetTopic | Type_350_SubscribeVersion | Type_350_Transact | Type_350_TransferAsset | Type_350_TransferReserveAsset | Type_350_Trap | Type_350_UniversalOrigin | Type_350_UnlockAsset | Type_350_UnpaidExecution | Type_350_UnsubscribeVersion | Type_350_WithdrawAsset

export interface Type_350_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_350_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_350_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_350_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_350_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_350_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_350_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_350_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_350_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_350_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_350_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_350_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_350_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_350_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_350_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_350_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_350_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_350_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_350_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_350_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_350_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export type Type_347 = Type_347_V3 | Type_347_V4 | Type_347_V5
...
export interface Type_347_V4 {
    __kind: 'V4'
    value: Type_354[]
}

export interface Type_347_V5 {
    __kind: 'V5'
    value: Type_357[]
}
