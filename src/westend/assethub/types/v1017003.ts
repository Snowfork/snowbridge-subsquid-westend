...
export const Type_350: sts.Type<Type_350> = sts.closedEnum(() => {
    return  {
        ...
        V4: sts.array(() => Type_357),
        V5: sts.array(() => Type_360),
    }
})
...
export const Type_354: sts.Type<Type_354> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})

export interface Type_354 {
    encoded: Bytes
}
...
export interface Type_360_ExecuteWithOrigin {
    __kind: 'ExecuteWithOrigin'
    descendantOrigin?: (V5Junctions | undefined)
    xcm: Type_360[]
}
...
export interface Type_360_InitiateTransfer {
    __kind: 'InitiateTransfer'
    destination: V5Location
    remoteFees?: (V5AssetTransferFilter | undefined)
    preserveOrigin: boolean
...
export interface Type_360_PayFees {
    __kind: 'PayFees'
    asset: V5Asset
}
...
export interface Type_360_SetHints {
    __kind: 'SetHints'
    hints: V5Hint[]
}
...
export type Type_357 = Type_357_AliasOrigin | Type_357_BurnAsset | Type_357_BuyExecution | Type_357_ClaimAsset | Type_357_ClearError | Type_357_ClearOrigin | Type_357_ClearTopic | Type_357_ClearTransactStatus | Type_357_DepositAsset | Type_357_DepositReserveAsset | Type_357_DescendOrigin | Type_357_ExchangeAsset | Type_357_ExpectAsset | Type_357_ExpectError | Type_357_ExpectOrigin | Type_357_ExpectPallet | Type_357_ExpectTransactStatus | Type_357_ExportMessage | Type_357_HrmpChannelAccepted | Type_357_HrmpChannelClosing | Type_357_HrmpNewChannelOpenRequest | Type_357_InitiateReserveWithdraw | Type_357_InitiateTeleport | Type_357_LockAsset | Type_357_NoteUnlockable | Type_357_QueryPallet | Type_357_QueryResponse | Type_357_ReceiveTeleportedAsset | Type_357_RefundSurplus | Type_357_ReportError | Type_357_ReportHolding | Type_357_ReportTransactStatus | Type_357_RequestUnlock | Type_357_ReserveAssetDeposited | Type_357_SetAppendix | Type_357_SetErrorHandler | Type_357_SetFeesMode | Type_357_SetTopic | Type_357_SubscribeVersion | Type_357_Transact | Type_357_TransferAsset | Type_357_TransferReserveAsset | Type_357_Trap | Type_357_UniversalOrigin | Type_357_UnlockAsset | Type_357_UnpaidExecution | Type_357_UnsubscribeVersion | Type_357_WithdrawAsset
...
export type Type_350 = Type_350_V3 | Type_350_V4 | Type_350_V5

export interface Type_350_V3 {
    __kind: 'V3'
    value: Type_353[]
}

export interface Type_350_V4 {
    __kind: 'V4'
    value: Type_357[]
}

export interface Type_350_V5 {
    __kind: 'V5'
    value: Type_360[]
}
