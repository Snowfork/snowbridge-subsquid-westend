...
const SUBSQUID_NETWORK =
  process.env["SUBSQUID_NETWORK_FREQUENCY"] || "frequency-westend";

const START_BLOCK = process.env["START_BLOCK_FREQUENCY"]
  ? parseInt(process.env["START_BLOCK_FREQUENCY"])
  : 334810;

const RPC_URL =
  process.env["RPC_FREQUENCY"] ||
  "wss://node-7330371704012918784.nv.onfinality.io/ws";
