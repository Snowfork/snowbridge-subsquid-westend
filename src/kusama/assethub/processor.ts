...
const SUBSQUID_NETWORK =
  process.env["SUBSQUID_NETWORK_ASSETHUB_KUSAMA"] || "asset-hub-kusama";

const START_BLOCK = process.env["START_BLOCK_ASSETHUB_KUSAMA"]
  ? parseInt(process.env["START_BLOCK_ASSETHUB_KUSAMA"])
  : 9395148;

const RPC_URL =
  process.env["RPC_KUSAMA_ASSETHUB"] ||
