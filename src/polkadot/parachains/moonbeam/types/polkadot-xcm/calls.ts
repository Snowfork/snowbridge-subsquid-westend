...
export const transferAssetsUsingTypeAndThen =  {
    ...
    v3701: new CallType(
        'PolkadotXcm.transfer_assets_using_type_and_then',
        sts.struct({
            dest: v3701.VersionedLocation,
            assets: v3701.VersionedAssets,
            assetsTransferType: v3701.TransferType,
            remoteFeesId: v3701.VersionedAssetId,
            feesTransferType: v3701.TransferType,
            customXcmOnDest: v3701.VersionedXcm,
            weightLimit: v3701.V3WeightLimit,
        })
    ),
}
