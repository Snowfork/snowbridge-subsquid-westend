...
export const transferAssetsUsingTypeAndThen =  {
    ...
    v20000: new CallType(
        'PolkadotXcm.transfer_assets_using_type_and_then',
        sts.struct({
            dest: v20000.VersionedLocation,
            assets: v20000.VersionedAssets,
            assetsTransferType: v20000.TransferType,
            remoteFeesId: v20000.VersionedAssetId,
            feesTransferType: v20000.TransferType,
            customXcmOnDest: v20000.VersionedXcm,
            weightLimit: v20000.V3WeightLimit,
        })
    ),
}
