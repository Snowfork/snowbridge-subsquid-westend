...
export const reserveTransferAssets =  {
    ...
    v145: new CallType(
        ...
        sts.struct({
            dest: v145.VersionedLocation,
            beneficiary: v145.VersionedLocation,
            assets: v145.VersionedAssets,
...
export const limitedReserveTransferAssets =  {
    ...
    v145: new CallType(
        ...
        sts.struct({
            ...
            assets: v145.VersionedAssets,
            feeAssetItem: sts.number(),
            weightLimit: v145.V3WeightLimit,
        })
    ),
}
...
export const transferAssetsUsingTypeAndThen =  {
    ...
    v145: new CallType(
        ...
        sts.struct({
            dest: v145.VersionedLocation,
            assets: v145.VersionedAssets,
            assetsTransferType: v145.TransferType,
            remoteFeesId: v145.VersionedAssetId,
            feesTransferType: v145.TransferType,
            customXcmOnDest: v145.VersionedXcm,
            weightLimit: v145.V3WeightLimit,
        })
    ),
}
